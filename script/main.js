...
// animation timeline
// ... (ऊपर का SweetAlert वाला कोड वैसा ही रहने दें)
...
const animationTimeline = () => {
    ...
    // --- यहाँ से सुधार शुरू है ---
    
    // 1. सबसे पहले .six को 'Visible' करें (यह पहले गायब था)
    .to(".six", 0.5, { opacity: 1, visibility: "visible" }, "-=1") 
    
    // 2. अब फोटो कार्ड्स को एक-एक करके एनिमेट करें
    .staggerFrom(".photo-card", 1, {
        scale: 0.5,
        opacity: 0,
        rotation: 45,
    ...
    // इसे 'opacity: 0' की जगह 'display: none' की तरह बर्ताव करने दें ताकि आखिर में दिक्कत न हो
    .to(".six", 0.5, { opacity: 0, y: 30, display: "none" }, "+=3") 
